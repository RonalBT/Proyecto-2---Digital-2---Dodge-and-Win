...
const int Button1_1 = 2; //Saltar
const int Button2_1 = 3; //Agacharse
const int Button1_2 = 4; //Saltar
const int Button2_2 = 5; //Agacharse
const int boton1 = 31;
const int boton2 = 17;
...
//--------------------- Condición para ambos jugadores -----------------------------------
  for(int x = 0; x < 10; x++){
    if(salto1 == 0 && agacharse1 == 0 && Muerte == 0){
      int anim3 = (x/4)%4;
      BolaFuego();
      PuntajeJuego++;
    ...
    if(salto2 == 0 && agacharse2 == 0 && Muerte == 0){
      int anim2 = (x/4)%4;
...
//--------------------------- Salto Jugador1 ------------------------------------------
  if(salto1 == 1 && agacharse1 == 0 && Muerte == 0){
...
//--------------------------- Agacharse Jugador1 ------------------------------------------
  if(agacharse1 == 1 && salto1 == 0 && Muerte == 0){
    //delay(1);
...
//--------------------------- Salto Jugador2 ------------------------------------------
  if(salto2 == 1 && agacharse2 == 0 && Muerte == 0){
...
//--------------------------- Agacharse Jugador2 ------------------------------------------
  if(agacharse2 == 1 && salto2 == 0 && Muerte == 0){
    //delay(1);
